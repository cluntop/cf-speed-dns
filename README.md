...
## cf-speed-dns有哪些功能？
* CloudflareSpeedTest优选IP，实时更新列表页面。[https://ip.clun.top](https://ip.clun.top)
* CloudflareSpeedTest优选IP，Top接口。[https://ip.clun.top/ipTop.html](https://ip.clun.top/ipTop.html)
