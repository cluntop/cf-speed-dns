...
def get_dns_records(name):
    def_info = []
    url = 'https://api.cloudflare.com/client/v4/zones/258a1db9ed6e92325e16b0bfb34220e6/dns_records'
...
def update_dns_record(dns_record_id, name, cf_ip):
    url = 'https://api.cloudflare.com/client/v4/zones/258a1db9ed6e92325e16b0bfb34220e6/dns_records/{dns_record_id}'
    data = {
        'type': 'A',
        'name': name,
        'content': cf_ip
